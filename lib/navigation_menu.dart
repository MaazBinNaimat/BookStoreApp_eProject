import 'package:bookstoreapp_eproject/features/shop/screens/home/home.dart';
...
class NavigationController extends GetxController {
  ...
  final screens = [
    const HomeScreen(),
    Container(color: Colors.yellow, child: Center(child: Text('Screen 2'))),
    Container(color: Colors.pink, child: Center(child: Text('Screen 3'))),
    Container(color: Colors.blue, child: Center(child: Text('Screen 4'))),
  ];
}
